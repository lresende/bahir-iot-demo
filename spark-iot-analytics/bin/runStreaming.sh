...
#weight
#DStream
$SPARK_HOME/bin/spark-submit --master spark://$HOSTNAME:7077 --packages org.apache.bahir:spark-streaming-mqtt_2.11:2.3.2 --jars ./lib/org.eclipse.paho.client.mqttv3-1.2.1.jar --class org.apache.bahir.iot.MQTTStreamingApplication  ./target/scala-2.11/spark-iot-analytics_2.11-1.0.jar tcp://localhost:1883 bahir/iot/id/simulator/evt/temp
