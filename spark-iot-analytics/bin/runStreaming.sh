...
#$SPARK_HOME/bin/spark-submit --master spark://$HOSTNAME:7077 --packages org.apache.bahir:spark-streaming-mqtt_2.11:2.0.1 --class org.apache.bahir.iot.MQTTStreamingApplication  ./target/scala-2.11/spark-iot-analytics_2.11-1.0.jar tcp://localhost:1883 bahir/iot/id/simulator/evt/power
$SPARK_HOME/bin/spark-submit --master spark://$HOSTNAME:7077 --packages org.apache.bahir:spark-streaming-mqtt_2.11:2.0.1 --jars ./lib/org.eclipse.paho.client.mqttv3-1.0.2.jar --class org.apache.bahir.iot.MQTTStreamingApplication  ./target/scala-2.11/spark-iot-analytics_2.11-1.0.jar tcp://localhost:1883 bahir/iot/id/simulator/evt/power
